...
function imprimeDadosLocalizacao() {
    ...
    localizacaoHtml1 += `
        <div> 
            <h4 class="font_logo color_theme">${objDadosRestaurantes.restaurantes[8].nome}</h4>
            <p>
                Endereço: ${objDadosRestaurantes.restaurantes[8].rua}, ${objDadosRestaurantes.restaurantes[8].numero} Bairro ${objDadosRestaurantes.restaurantes[8].bairro}, ${objDadosRestaurantes.restaurantes[8].cidade}<br>
                Telefone: ${objDadosRestaurantes.restaurantes[8].telefone}<br>
                <a class = "color_theme" href="${objDadosRestaurantes.restaurantes[8].redeSocial}" target="_blank">Instagram</a><br>
            </p>
        </div>`;
