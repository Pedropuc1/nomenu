...
function imprimeDadosLocalizacao() {
    ...
    localizacaoHtml1 += `
        <div> 
            <h4 class="font_logo color_theme">${objDadosRestaurantes.restaurantes[5].nome}</h4>
            <p>
                Endereço: ${objDadosRestaurantes.restaurantes[5].rua}, ${objDadosRestaurantes.restaurantes[5].numero} Bairro ${objDadosRestaurantes.restaurantes[5].bairro}, ${objDadosRestaurantes.restaurantes[5].cidade}<br>
                Telefone: ${objDadosRestaurantes.restaurantes[5].telefone}<br>
                <a class = "color_theme" href="${objDadosRestaurantes.restaurantes[5].redeSocial}" target="_blank">Instagram</a><br>
            </p>
        </div>`;
