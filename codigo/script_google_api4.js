...
function imprimeDadosLocalizacao() {
    ...
    localizacaoHtml1 += `
        <div> 
            <h4 class="font_logo color_theme">${objDadosRestaurantes.restaurantes[3].nome}</h4>
            <p>
                Endereço: ${objDadosRestaurantes.restaurantes[3].rua}, ${objDadosRestaurantes.restaurantes[3].numero} Bairro ${objDadosRestaurantes.restaurantes[3].bairro}, ${objDadosRestaurantes.restaurantes[3].cidade}<br>
                Telefone: ${objDadosRestaurantes.restaurantes[3].telefone}<br>
                <a class = "color_theme" href="${objDadosRestaurantes.restaurantes[3].redeSocial}" target="_blank">Instagram</a><br>
            </p>
        </div>`;
