...
function imprimeDadosLocalizacao() {
    ...
    localizacaoHtml1 += `
        <div> 
            <h4 class="font_logo color_theme">${objDadosRestaurantes.restaurantes[4].nome}</h4>
            <p>
                Endereço: ${objDadosRestaurantes.restaurantes[4].rua}, ${objDadosRestaurantes.restaurantes[4].numero}, Bairro ${objDadosRestaurantes.restaurantes[4].bairro}, ${objDadosRestaurantes.restaurantes[4].cidade}<br>
                Telefone: ${objDadosRestaurantes.restaurantes[4].telefone}<br>
                <a class = "color_theme" href="${objDadosRestaurantes.restaurantes[4].redeSocial}" target="_blank">Instagram</a><br>
            </p>
        </div>`;
