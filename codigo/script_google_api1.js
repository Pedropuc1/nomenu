...
function imprimeDadosLocalizacao() {
    ...
    localizacaoHtml1 += `
        <div> 
            <h4 class="font_logo color_theme">${objDadosRestaurantes.restaurantes[1].nome}</h4>
            <p>
                Endereço: ${objDadosRestaurantes.restaurantes[1].rua}, ${objDadosRestaurantes.restaurantes[1].numero} Bairro ${objDadosRestaurantes.restaurantes[1].bairro}, ${objDadosRestaurantes.restaurantes[1].cidade}<br>
                Telefone: ${objDadosRestaurantes.restaurantes[1].telefone}<br>
                <a class = "color_theme" href="${objDadosRestaurantes.restaurantes[1].redeSocial}" target="_blank">Instagram</a><br>
                Email: ${objDadosRestaurantes.restaurantes[1].email}<br>
            </p>
        </div>`;
