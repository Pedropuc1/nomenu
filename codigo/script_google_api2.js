...
function imprimeDadosLocalizacao() {
    ...
    localizacaoHtml1 += `
        <div> 
            <h4 class="font_logo color_theme">${objDadosRestaurantes.restaurantes[0].nome}</h4>
            <p>
                Endereço: ${objDadosRestaurantes.restaurantes[0].rua}, ${objDadosRestaurantes.restaurantes[0].numero} Bairro ${objDadosRestaurantes.restaurantes[0].bairro}, ${objDadosRestaurantes.restaurantes[0].cidade}<br>
                Telefone: ${objDadosRestaurantes.restaurantes[0].telefone}<br>
                <a class = "color_theme" href="${objDadosRestaurantes.restaurantes[1].redeSocial}" target="_blank">Instagram</a><br>
                Email: ${objDadosRestaurantes.restaurantes[0].email}<br>
            </p>
        </div>`;
