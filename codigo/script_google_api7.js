...
function imprimeDadosLocalizacao() {
    ...
    localizacaoHtml1 += `
        <div> 
            <h4 class="font_logo color_theme">${objDadosRestaurantes.restaurantes[6].nome}</h4>
            <p>
                Endereço: ${objDadosRestaurantes.restaurantes[6].rua}, ${objDadosRestaurantes.restaurantes[6].numero} Bairro ${objDadosRestaurantes.restaurantes[6].bairro}, ${objDadosRestaurantes.restaurantes[6].cidade}<br>
                Telefone: ${objDadosRestaurantes.restaurantes[6].telefone}<br>
                <a class = "color_theme" href="${objDadosRestaurantes.restaurantes[6].redeSocial}" target="_blank">Instagram</a><br>
            </p>
        </div>`;
